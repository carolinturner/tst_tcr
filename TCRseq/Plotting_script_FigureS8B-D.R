...
# alpha chain data
c <- a %>% filter(Chain == "alpha") %>% na.omit() %>% mutate(Clone.Size = "All CDR3s")
d <- b %>% filter(Chain == "alpha") %>% na.omit() %>% mutate(Clone.Size = "Expanded CDR3s")
...
# Figure S8C: full repertoires beta ####
a <- read.csv("data/summary_metaclone-abundance_full-repertoires_expanded_gr0.csv")
b <- read.csv("data/summary_metaclone-abundance_full-repertoires_expanded_gr1.csv")
...
# Figure S8D: full repertoires, alpha ####
a <- read.csv("data/summary_metaclone-abundance_full-repertoires_expanded_gr0.csv")
b <- read.csv("data/summary_metaclone-abundance_full-repertoires_expanded_gr1.csv")
